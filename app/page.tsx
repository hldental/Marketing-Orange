        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-8 text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Missing teeth, failing teeth, or wondering if full-arch is right
              for you?
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
              Answer a few quick questions so our team can understand your
              situation and call you to discuss whether a surgery/prosthetic
              consultation is the right next step.
            </p>

            <p className="mt-4 max-w-2xl text-lg leading-8 text-zinc-300">
              This page is designed for patients exploring implants, dentures,
              extractions, full arch or complex restorative solutions.
            </p>
            ...
            <div className="mt-5 space-y-5">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-zinc-300">
                  Tell us about missing teeth, full-arch interest, and budget
                  range.
                </p>
              </div>
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-zinc-300">
                  Our team looks at your goals and helps determine the right
                  next step.
                </p>
              </div>
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-zinc-300">
                  If it looks like a fit, we will contact you to schedule your
                  consultation.
                </p>
              </div>
            </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <Card className="p-8 lg:p-10">
            ...
            <p className="mt-4 text-base leading-7 text-zinc-300">
              This page is intended for patients who may need advanced tooth
              replacement or surgical care and want to know what options may be
              available.
            </p>
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-2xl border border-zinc-800 bg-black/40 p-4">
                ...
                <p className="mt-1 text-sm leading-6 text-zinc-300">
                  Patients already missing teeth or facing multiple extractions.
                </p>
              </div>

              <div className="rounded-2xl border border-zinc-800 bg-black/40 p-4">
                <p className="text-sm font-semibold text-white">
                  Full-arch or complex restorative solutions
                </p>
                <p className="mt-1 text-sm leading-6 text-zinc-300">
                  People exploring dentures, implants, or full-arch replacement.
                </p>
              </div>

              <div className="rounded-2xl border border-zinc-800 bg-black/40 p-4">
                <p className="text-sm font-semibold text-white">
                  Planning-focused conversation
                </p>
                <p className="mt-1 text-sm leading-6 text-zinc-300">
                  A starting point for patients who want clarity before
                  scheduling.
                </p>
              </div>
            </div>
          ...
          <Card className="p-8 lg:p-10">
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-300">
              If it looks like you may be a fit for our surgery/prosthetic
              clinic, our team will call you to discuss your options and
            ...
            >
              ...
              <label className="grid gap-2 text-sm font-medium text-zinc-200">
                ...
                >
                  ...
                  <option value="Need to discuss options">
