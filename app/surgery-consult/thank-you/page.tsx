...
export default function ThankYouSurgeryPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-black px-6 text-white">
      <div className="max-w-xl rounded-3xl border border-zinc-700 bg-zinc-900 p-10 text-center shadow-xl">
        ...
        <p className="mt-4 text-base leading-7 text-zinc-300">
          Our team will review your information and contact you if a surgery/prosthetic consultation looks like the right next step.
        </p>
        <a href="/surgery-consult" className="mt-8 inline-block rounded-2xl bg-orange-500 px-6 py-3 text-sm font-semibold text-black hover:bg-orange-600">
          Return to the page
        </a>
      </div>
    </main>
